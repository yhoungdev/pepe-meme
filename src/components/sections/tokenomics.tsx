  ...
  return (
    <div className="py-[5em] my-[5em]">
      <div className="container mx-auto text-center">
        ...
        <div className="mt-[3em] bg-gray-900  w-full md:w-[700px] mx-auto px-5 py-[5em] rounded-xl">
        ...
        <div className=" bg-gray-900 mt-5  w-full md:w-[700px] mx-auto px-5 py-[5em] rounded-xl">
          <h1 className="text-xl md:text-2xl font-bold default-text ">TOKEN SUPPLY</h1>
